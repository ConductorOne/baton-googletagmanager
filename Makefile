...
ifeq ($(GOOS),windows)
OUTPUT_PATH = ${BUILD_DIR}/baton-googletagmanager.exe
else
OUTPUT_PATH = ${BUILD_DIR}/baton-googletagmanager
endif
...
build: $(GENERATED_CONF)
	go build ${BUILD_TAGS} -o ${OUTPUT_PATH} ./cmd/baton-googletagmanager
